        ...
        return (
            <div className="StatusBar">
                <div className="progress">
                    ...
                    <div className="progress-bar progress-bar-striped bg-danger" role="progressbar" style={this.bar(studentsInClass, histogram.red)} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{title}</div>
